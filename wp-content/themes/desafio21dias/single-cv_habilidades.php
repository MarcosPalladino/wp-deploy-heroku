...
<head>
  <title>Marcos Palladino - Curriculum Vitae</title>

  <meta name="viewport" content="width=device-width" />
  <meta name="description" content="Curriculum Vitae de Marcos Palladino." />
  <meta charset="UTF-8">
  ...
  <div id="cv" class="instaFade">
    <div class="mainDetails">
      <div id="headshot" class="quickFade">
        <img src="<?php echo $url; ?>/assets/img/foto.jpg" alt="marcospalladino" />
      </div>
      <div id="name">
